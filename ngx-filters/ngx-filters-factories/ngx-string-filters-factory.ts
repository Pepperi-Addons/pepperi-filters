...
import { NGXFilterBeginsWithOperation, NGXFilterContainsOperation, NGXFilterEndsWithOperation, NGXFilterIsEqualOperation, NGXFilterNotEqualOperation, NGXFilterOperation } from "../json-to-ngx/ngx-filters-operations";
