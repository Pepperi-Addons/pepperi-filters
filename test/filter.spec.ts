...
import { JSONFilter, JSONBoolFilter } from '../json-filter'
...
describe('Filtering objects with JSON Filter', function(){
    ...
    describe('Date Time Filter', function() {
        describe('=', function() {
            it('should be equal', function() {
                const res = filter([
                    { TSADateTime: '2020-06-04T09:08:30.783Z' }
                ], {
                    FieldType: 'DateTime',
                    ApiName: 'TSADateTime',
                    Operation: '=',
            ...
            it('should not be equal', function() {
                const res = filter([
                    { TSADateTime: '2020-06-04T09:09:49.076Z' }
                ], {
                    FieldType: 'DateTime',
                    ApiName: 'TSADateTime',
                    Operation: '=',
        ...
        describe('>', function() {
            it('should be greater', function() {
                const res = filter([
                    { TSADateTime: '2020-06-04T09:09:49.077Z' }
                ], {
                    FieldType: 'DateTime',
                    ApiName: 'TSADateTime',
                    Operation: '>',
            ...
            it('should not be greater', function() {
                const res = filter([
                    { TSADateTime: '2020-06-04T09:09:49.075Z' },
                    { TSADateTime: '2020-06-04T09:09:49.076Z' }
                ], {
                    FieldType: 'DateTime',
                    ApiName: 'TSADateTime',
        ...
        describe('<', function(){
            ...
            it('should not be less than', function() {
                const res = filter([
                    { TSADateTime: '2020-06-04T09:09:49.078Z' },
                    { TSADateTime: '2020-06-04T09:09:49.079Z' },
                ], {
                    FieldType: 'DateTime',
                    ApiName: 'TSADateTime',
                    Operation: '<',
    ...
    describe('Guid Filter', function() {
        describe('IsEqual', function() {
            ...
            it('should not be equal', function() {
                const res = filter([
                    { TSAGuid: 'c6422c48-5719-408f-827e-a4852596b3d9' }
                ], {
                    FieldType: 'Guid',
                    Operation: 'IsEqual',
                    ApiName: 'TSAGuid',
        ...
        describe('IsEmpty', function() {
            ...
            it('should not be empty', function() {
                const res = filter([
                    { TSAGuid: '5b4a63d8-fa54-428b-8da5-b80399846ad8' }
                ], {
                    FieldType: 'Guid',
                    Operation: 'IsEmpty',
                    ApiName: 'TSAGuid',
            ...
            it('NULL GUID is considered empty', function() {
                const res = filter([
                    { TSAGuid: '00000000-0000-0000-0000-000000000000' }
                ], {
                    FieldType: 'Guid',
                    Operation: 'IsEmpty',
                    ApiName: 'TSAGuid',
